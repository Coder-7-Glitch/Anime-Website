            ...
            <div className="inset-0 hero-slider-gradient z-10 h-[100vh] w-full">
                <div className="hero-content pt-[11rem] pl-[13rem]">
                    ...
                    <div className="movie-summary">
                        <p className="hidden md:block mt-3 text-gray-300 w-[40%]">Desperate to defend her village from the demon king, Reiko offers herself to a 5,000-year-old dragon for his help in exchange, but the flame-breathing beast is vegetarian and a total weakling.</p>
                    </div>
                    <div className="watch-btn">
                        <button type="button" className='mt-4 bg-[#ff640a] flex items-center gap-3 px-6 py-2 rounded font-workSans font-medium'>
                            <div className="icon">
