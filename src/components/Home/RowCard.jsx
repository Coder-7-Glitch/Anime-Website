    ...
    return (
        <div>
            <div className="xl:px-20 lg:px-12 md:px-10 px-4 py-20 lg:flex gap-10">
                <div className="img">
                    <img src="/assets/img/ViralHit2.jpg" alt="" className='w-full rounded h-auto min-h-[250px] max-h-[300px]' />
                </div>
                <div className="content mt-8 w-full">
                    ...
                    <p className='text-[#888888] mt-4 text-sm md:text-[15px] md:w-[70%]'>Several thousand years after a mysterious phenomenon that turns all of humanity to stone, the extraordinarily intelligent, science-driven boy, Senku Ishigami, awakens. Facing a world of stone and the total collapse of civilization,</p>
                    <div className="mt-4">
