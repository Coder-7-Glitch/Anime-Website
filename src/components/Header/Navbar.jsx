        ...
        <div className="h-full flex gap-8 items-center px-4 sm:px-7 md:px-9 lg:px-14 max-w-7xl mx-auto justify-between">
          <div className="left-text flex items-center gap-5 me-auto">
            ...
            <ul className='hidden lg:flex gap-5 me-auto'>
              ...
              <li>
                <Link to={'/'} className='font-medium text-[17px]'>News</Link>
              </li>
            </ul>
            {/* <!-- lg-flex Navbar List end */}
            {/* <!-- Mobile Navbar List start */}
            <ul className='transition-all duration-300 py-10 block lg:hidden gap-5 me-auto absolute top-[70px] h-[100vh] left-[-800px] w-full sm:w-[320px] bg-zinc-900 z-[3]' ref={offCanvas}>
          ...
          <button type="button" onClick={toggleNav}><GiHamburgerMenu className='text-3xl lg:hidden' /></button>
        </div>
      </header>
    </div>
  )
